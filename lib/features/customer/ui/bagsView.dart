...
class BagsView extends StatelessWidget {
  List<Product> bagsProduct = [];
  @override
  Widget build(BuildContext context) {
    return Consumer<AdminProvider>(
      builder: (context, value, child) {
        bagsProduct = value.bagProducts;
        //print(dressProduct.length);
        if (bagsProduct.isEmpty) {
          return Center(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Positioned.fill(
                        child: Image(
                          fit: BoxFit.fill,
                          //image: AssetImage('images/dresses/dress2.jpg'),
                          image: NetworkImage(bagsProduct[index].imageUrl),
                        ),
                      ),
                      Positioned(
                        bottom: 0,
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    bagsProduct[index].name,
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                  ),
                                  Text('\$ ${bagsProduct[index].price}'),
                                ],
                              ),
                            ),
                          ),
